...
*************************************************************************************************8
ARRAY 
//ITS A HOMOGENIOUS COLLECTION OF VARIABLES OF SAME DATA TYPE 
SYNTAX DATATYPE ARRAY_NAME[SIZEOF_ARRAY]

//pointers 

#include<stdio.h>
void function_1(int *sum){
    *sum=*sum + 10;
...
int main(){
    int x=5;
    printf("before calling function %d,x");
    function_1(&x);
    printf("after calling function %d,x");
